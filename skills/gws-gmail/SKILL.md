...
| [`+read`](../gws-gmail-read/SKILL.md) | Read a complete message or conversation with decoded bodies and attachment metadata |
| [`+search`](../gws-gmail-search/SKILL.md) | Search Gmail and retrieve complete readable messages |
